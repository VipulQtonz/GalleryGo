...
class SelectedOptionsAdapter(
    private val options: List<EditOptionItems>
) : RecyclerView.Adapter<SelectedOptionsAdapter.EditOptionViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): EditOptionViewHolder {
        val view = LayoutInflater.from(parent.context)
            .inflate(R.layout.selected_image_options_single_item, parent, false)
