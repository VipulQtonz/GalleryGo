...
public class HorizontalProgressWheelView extends View {
    ...
    private void init() {
        ...
        getContext().getTheme().resolveAttribute(R.attr.colorApp, typedValue, true);
        mMiddleLineColor = typedValue.data;
        ...
        mProgressLinePaint.setColor(getResources().getColor(R.color.white));

        mProgressMiddleLinePaint = new Paint(mProgressLinePaint);
        mProgressMiddleLinePaint.setColor(mMiddleLineColor);
        mProgressMiddleLinePaint.setStrokeCap(Paint.Cap.ROUND);
        mProgressMiddleLinePaint.setStrokeWidth(getContext().getResources().getDimensionPixelSize(R.dimen.crop_width_middle_wheel_progress_line));
    }
