...
import com.photogallery.photoEditor.photoEditorHelper.MultiTouchListener.OnGestureControl
...
internal abstract class Graphic(
    ...
    protected fun toggleSelection() {
        ...
        if (frmBorder != null) {
            frmBorder.setBackgroundResource(R.drawable.bg_rounded_corner_text)
            frmBorder.tag = true
        }
        if (imgClose != null) {
